...
*/
    ...
    public static void showNativeAd(Activity activity, String nativeAd, CardView adContainer, int isFullScreenAd, Drawable imageID) {
        ...
        if (!Constants.isFixed) {
            ...
            FixedSequenceAdUtils.showNativeAd(activity, adContainer, isFullScreenAd, imageID);
        }
    }

    public static void populateUnifiedNativeAdView(Activity activity, NativeAd unifiedNativeAd, NativeAdView unifiedNativeAdView, int flag) {
        if (flag == 1) {
