...
public class Global {
    ...
    public static void showAlertProgressDialog(Activity activity) {
        System.out.println("Package Activity>>>>>>>> "+activity.getClass());
        if (!activity.getClass().toString().equals("class com.batteryanimation.neonbatteryeffects.charge.Activity.SplashActivity")){
