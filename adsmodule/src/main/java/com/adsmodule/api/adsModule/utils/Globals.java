...
public class Globals {
    ...
    public static void showLoadingDialog(Activity activity) {
        if (!activity.getComponentName().getClassName().equals("com.batteryanimation.neonbatteryeffects.charge.Activity.SplashActivity")) { // Change this classpath according to your SplashScreen Activity
