...
public class WallpaperGridAdapter extends RecyclerView.Adapter<WallpaperGridAdapter.ViewHolder> {
    ...
    int i = 0;
    public WallpaperGridAdapter(Context context, List<Wallpaper> lockThemeModelArrayList, int i) {
    ...
    @NonNull
    @Override
    public WallpaperGridAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.animation_grid_list, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull WallpaperGridAdapter.ViewHolder holder, int position) {
